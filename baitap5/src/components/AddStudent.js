                    ...
                    <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
                        {({ handleSubmit, errors, touched }) => (
                            <Form noValidate onSubmit={handleSubmit}>
                                <FormRow label="Họ và Tên" name="name" type="text" placeholder="Nhập Họ và Tên" errors={errors} touched={touched} />
                                <FormRow label="Tuổi" name="age" type="number" placeholder="Nhập Tuổi" errors={errors} touched={touched} />
                                <GenderField errors={errors} touched={touched} />
                                <ClassSelect classes={classes} errors={errors} touched={touched} />
                                <FormRow label="Địa Chỉ" name="address" type="text" placeholder="Nhập Địa Chỉ" errors={errors} touched={touched} />
                                <Row>
...
const FormRow = ({ label, name, type, placeholder, errors, touched }) => (
    <Row className="mb-3">
        ...
        <Col md={8}>
            <Field type={type} name={name} placeholder={placeholder} className={`form-control ${errors[name] && touched[name] ? 'is-invalid' : ''}`} />
    ...
    <Row className="mb-3">
        ...
        <Col md={8}>
            <div role="group" aria-labelledby="gender-group">
                <Field type="radio" name="gender" value="Nam" id="male" className={errors.gender && touched.gender ? 'is-invalid' : ''} />
                <label htmlFor="male" className="me-3">Nam</label>
                <Field type="radio" name="gender" value="Nữ" id="female" className={errors.gender && touched.gender ? 'is-invalid' : ''} />
                <label htmlFor="female" className="me-3">Nữ</label>
                <Field type="radio" name="gender" value="Khác" id="other" className={errors.gender && touched.gender ? 'is-invalid' : ''} />
...
const ClassSelect = ({ classes, errors, touched }) => (
    <Row className="mb-3">
        ...
        <Col md={8}>
            <Field as="select" name="classId" className={`form-control ${errors.classId && touched.classId ? 'is-invalid' : ''}`}>
